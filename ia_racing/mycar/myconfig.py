...
DONKEY_GYM = True
DONKEY_SIM_PATH = "/home/ia-racing/DonkeySimLinux/DonkeySimLinux/donkey_sim.x86_64"
...
JOYSTICK_MAX_THROTTLE = 0.9         #this scalar is multiplied with the -1 to 1 throttle value to limit the maximum throttle. This can help if you drop the controller or just don't need the full speed available.
JOYSTICK_STEERING_SCALE = 2.0       #some people want a steering that is less sensitve. This scalar is multiplied with the steering -1 to 1. It can be negative to reverse dir.
...
# JOYSTICK_DEADZONE = 0.1            # when non zero, this is the smallest throttle before recording triggered.
